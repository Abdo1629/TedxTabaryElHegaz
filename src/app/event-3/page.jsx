            ...
            <div className="content-wrapper fade-in">
                ...
                <div className="event-rules">
                    ...
                    <ol>
                        ...
                        <li>الاحترام والسلوك: يلتزم TEDx ببيئة شاملة ومحترمة وإيجابية. لن يتم التسامح مع أي سلوك مزعج أو غير محترم. يجب على المشاركين الامتناع عن استخدام لغة مسيئة أو إيماءات غير لائقة أو أي شكل من أشكال التحرش.</li>
                        <li>التصوير والتسجيل: لا يُسمح للمشاركين بتسجيل أو التقاط صور للحدث دون إذن مسبق من المنظمين. سيكون هناك مصورون رسميون يقومون بالتصوير خلال الحدث.</li>
                        ...
                        <li>الصحة والسلامة: الالتزام بأي بروتوكولات صحية وإجراءات السلامة التي يضعها المنظمون. إذا شعرت بأي توعك أثناء الحدث، يرجى إبلاغ أحد أفراد الطاقم على الفور.</li>
